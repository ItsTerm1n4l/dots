...
alias nv "nvim"
alias npm "pnpm"
alias ll "eza --icons=always --no-permissions -l --no-user --no-time"
alias bat "batcat"
...
#    echo " ❯ "  
  ...
  # Square
  echo (set_color --background blue)(set_color black)   (set_color blue) (set_color normal)(set_color --background black) (pwd | sed "s|^$HOME|~|") (set_color --background normal)  (set_color normal)
